...
__decorateClass([IsNumber()], AccountGetUserRequest.prototype, 'userId', 2)
...
__decorateClass(
  ...
  AccountRegisterRequest.prototype,
  'email',
  2,
)
__decorateClass(
  [IsDefined(), MinLength(8), MaxLength(32)],
  AccountRegisterRequest.prototype,
  'password',
  2,
)
...
__decorateClass([IsEmail2()], AccountLoginRequest.prototype, 'email', 2)
__decorateClass([IsString()], AccountLoginRequest.prototype, 'password', 2)
...
__decorateClass(
  [IsDefined2()],
  AccountLogoutRequest.prototype,
  'refreshToken',
  2,
)
var AccountLogoutResponse = class {
  ok
}

// src/account/account.refresh.ts
import { IsDefined as IsDefined3 } from 'class-validator'
var accountRefreshTopic = 'account.refresh.command'
var AccountRefreshRequest = class {
  refreshToken
}
__decorateClass(
  [IsDefined3()],
  AccountRefreshRequest.prototype,
  'refreshToken',
  2,
)
var AccountRefreshResponse = class {
  accessToken
  refreshToken
}
export {
